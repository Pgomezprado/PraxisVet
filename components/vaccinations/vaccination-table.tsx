...
function StatusBadge({ status }: { status: VaccinationStatus | null }) {
  ...
  const config = {
    ...
    por_vencer: { label: "Proxima", variant: "outline" as const, className: "border-amber-500 text-amber-600 bg-amber-50 dark:bg-amber-950/30" },
                      ...
                      >
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              Se eliminara el registro de {vac.vaccine_name} del{" "}
                              {formatDate(vac.date_administered)}. Esta accion no se
                              puede deshacer.
                            </DialogDescription>
                          </DialogHeader>
                          <DialogFooter>
